 ...
 */
var tb_pathToImage = "frontend/themes/Yokohama/images/pleasewait.gif";
...
// Adopted by mso@phlylabs.de to only react on double clicks
//
...
function tb_show(caption, url, imageGroup)
{
    try {
        ...
        // Next two lines added by mso@phlylabs.de
        ...
        if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp' //code to show images
                || (params['TBlinktype'] && params['TBlinktype'] == 'image')) { // TBlinktype added by mso@phlylabs.de
            TB_PrevCaption = "";
            TB_PrevURL = "";
            TB_PrevHTML = "";
            TB_NextCaption = "";
            ...
            imgPreloader.onload = function() {
                ...
                $("#TB_window").append("<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='"+url+"' width='"+imageWidth
                ...
                document.onkeydown = function(e) {
                    ...
                    if (keycode == 27) { // close
                        tb_remove();
                    } else if (keycode == 190 || keycode == 39) { // display previous image; Cursor Right added by mso@phlylabs.de
                        if (!(TB_NextHTML == "")) {
                            document.onkeydown = "";
                            goNext();
                        }
                    } else if (keycode == 188 || keycode == 37) { // display next image; Cursor Left added by mso@phlylabs.de
                        if (!(TB_PrevHTML == "")) {
                            document.onkeydown = "";
                            goPrev();
                        }
