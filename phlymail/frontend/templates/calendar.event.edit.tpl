...
$(document).ready(function (e) {
    ...
    $('#sel_group').on('change', function () {
        if ($(this).find(':selected').hasClass('readonly')) {
            $('.button_store_event, .button_delete_event').hide();
        } else {
            $('.button_store_event, .button_delete_event').show();
        }
    }).trigger('change');
    ...
    $('#btn_save').on('click keyup', function () {
        $('#hiddensaveascopy').remove();
    });

    $('#btn_saveascopy').on('click keyup', function () {
        $('#hiddensaveascopy').remove();
        $('#masterform').append('<input type="hidden" id="hiddensaveascopy" name="copyevent" value="1"/>');
    });
});
/*]]>*/
</script>
<div style="width:455px;">
    <form id="masterform" action="#" method="post" onsubmit="return save_event();">
        <div id="tabpane" class="ui-tabpane" style="height:456px;margin-top:4px;">
            ...
            <div id="generic">
                <table border="0" cellpadding="2" cellspacing="0" width="100%">
                    ...
                    <!-- tr>
                        ...
                        <td class="l">
                            <select size="1" name="pid">
                                ...
                                <option value="{id}"<!-- START selected --> selected<!-- END selected -->>{name}</option><!-- END projectline -->
                            </select>
                        </td>
                    </tr -->
                    <tr>
                        <td class="l">{msg_group}</td>
                        <td class="l">
                            <select size="1" name="gid" id="sel_group"><!-- START groupline -->
                                <option value="{id}"<!-- START selected --> selected<!-- END selected --> class="<!-- START readonly --> readonly<!-- END readonly -->">{name}</option><!-- END groupline -->
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td class="l">{msg_type}</td>
                        <td class="l">
                            <select id="sel_type" size="1" name="type"><!-- START typeline -->
                                <option value="{id}"<!-- START sel --> selected<!-- END sel -->>{name}</option><!-- END typeline -->
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="l">
                            <select id="sel_status" size="1" name="status"><!-- START statusline -->
                                <option value="{id}"<!-- START sel --> selected<!-- END sel -->>{name}</option><!-- END statusline -->
                            </select>
                            /
                            <select size="1" name="opaque"><!-- START opacityline -->
                                <option value="{id}"<!-- START sel --> selected<!-- END sel -->>{name}</option><!-- END opacityline -->
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td class="l">
                            <input type="checkbox" name="allday" value="1" id="chk_allday"<!-- START is_allday --> checked<!-- END is_allday --> />
            ...
            <div id="reminders">
                <input type="checkbox" id="warn" name="warn" value="1"<!-- START warn --> checked<!-- END warn --> />
                ...
                <div id="warndisable">
                    <div id="reminders_template" style="position:relative;">
                        ...
                        <select size="1" name="reminders[range][]" id="reminders_range_0">
                            <option value="m"<!-- START s_w_m --> selected<!-- END s_w_m -->>{msg_minutes}</option>
                            <option value="h"<!-- START s_w_h --> selected<!-- END s_w_h -->>{msg_hours}</option>
                            <option value="d"<!-- START s_w_d --> selected<!-- END s_w_d -->>{msg_days}</option>
                            <option value="w"<!-- START s_w_w --> selected<!-- END s_w_w -->>{msg_weeks}</option>
                        </select>
                        <select size="1" name="reminders[mode][]" id="reminders_mode_0">
                            <option value="s"<!-- START s_w_s --> selected<!-- END s_w_s -->>{msg_warnbeforestart}</option>
                            <option value="e"<!-- START s_w_e --> selected<!-- END s_w_e -->>{msg_warnbeforeend}</option>
                        </select>
                        <br />
            ...
            <div id="repetition" class="l t">
                <div id="repetitions_template" style="position:relative;">
                    ...
                    <select name="repetitions[month][]" size="1"><!-- START repmonlin -->
                        <option value="{day}"<!-- START sel --> selected<!-- END sel -->>{msg_day}</option><!-- END repmonlin -->
                    </select>
                    <br />
                    <table border="0" cellpadding="2" cellspacing="0">
                        <tr>
                    ...
                    <select name="repetitions[week][]" size="1"><!-- START repweelin -->
                        <option value="{day}"<!-- START sel --> selected<!-- END sel -->>{msg_day}</option><!-- END repweelin -->
                    </select>
                    <br />
                    ...
                    <br />
                    <input type="checkbox" name="repetitions[has_repunt][0]" id="has_repunt_0" class="chk_repunt" value="1"<!-- START has_repunt --> checked<!-- END has_repunt --> />
        ...
        <div style="margin:2px 4px 4px 4px;;height:24px;"><!-- START delete_button -->
            <div style="float:right;">
                <button type="button" class="error button_delete_event" onclick="delete_event()">{msg_dele}</button>
            </div><!-- END delete_button -->
            <div><!-- START save_button -->
                <button type="submit" id="btn_save" class="ok button_store_event">%h%save%</button>&nbsp;<!-- END save_button --><!-- START saveascopy -->
                <button type="submit" id="btn_saveascopy" class="ok button_store_event">%h%CalSaveAsCopy%</button>&nbsp;<!-- END saveascopy -->
                <img id="busy" src="{theme_path}/images/busy.gif" style="visibility:hidden" alt="…" title="…" />
            </div>
        </div>
    </form>
