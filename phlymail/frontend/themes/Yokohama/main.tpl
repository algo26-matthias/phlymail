...
<tr>
 <td class="solid_line t l" id="topmenucontainer">
 ...
 <table border="0" cellpadding="0" cellspacing="0">
  <tr class="solid_nodrop" id="pm_menu_container">
   ...
   <td><a href="javascript:void(0);" id="topmendrop_settings" class="active" onmouseover="pm_menu_create('settings');" onclick="pm_menu_switch(this)">{top_setup}</a></td>
   <td class="men_separator"></td>
   ...
   <td class="men_separator"></td>
   <td><a href="javascript:void(0);" id="topmendrop_view" class="active" onmouseover="pm_menu_create('view');" onclick="pm_menu_switch(this)">{top_view}</a></td>
   <td class="men_separator"></td>
   <td><a href="javascript:void(0);" id="topmendrop_fetchitems" class="active" onmouseover="pm_menu_create('fetchitems');" onclick="pm_menu_switch(this)">{top_getmsg}</a></td>
   <td class="men_separator"></td>
   <td><a href="javascript:void(0);" id="topmendrop_system" class="active" onmouseover="pm_menu_create('system');" onclick="pm_menu_switch(this)">{top_system}</a></td>
   <td class="men_separator"></td>
...
<div id="namepane" class="sendmenutopline" style="display:none;">
 <table border="0" cellpadding="0" cellspacing="0" width="100%" id="mainbar">
  <tr>
   ...
   <span id="foldername" style="color:black;">{main_folderoverview}</span>
   </td>
...
<div>
 ...
 <tr>
  <td width="{folderlist_width}" height="200" id="PHM_tl_container" class="sendmenuborder t l">
